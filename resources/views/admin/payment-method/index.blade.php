                                    ...
                                    <div class="col-xxl-8">
                                        ...
                                        @elseif ($field['type'] === 'password')
                                            <input class="form-control" type="password" name="{{ $fieldKey }}"
                                                ...
                                                value="{{ encryptKey($fieldValue) }}" autocomplete="off">
                                        @elseif ($field['type'] === 'text')
                                            <input class="form-control" type="text" name="{{ $fieldKey }}"
                                                id="{{ $fieldKey }}" placeholder="{{ $field['label'] }}"
                                                value="{{ @$paymentMethod['title'] }}" autocomplete="off">
                                        @elseif ($field['type'] === 'number')
                                            <input class="form-control" type="number" name="{{ $fieldKey }}"
                                                id="{{ $fieldKey }}" placeholder="{{ $field['label'] }}"
                                                value="{{ @$paymentMethod['processing_fee'] }}" autocomplete="off">
                                        ...
                                        @else
                                            <input class="form-control" type="{{ $field['type'] }}"
                                                ...
                                                value="{{ encryptKey($fieldValue) }}" placeholder="{{ $field['label'] }}" autocomplete="off">
                                        @endif
                                    </div>
                                </div>
                            @endforeach
