                            ...
                            <div class="invoice-data">
                                ...
                                <div class="ride-details">
                                    ...
                                    <p class="dark-color"><?php echo e(__('taxido::static.invoice.pickup_time')); ?>: <span
                                            class="common-color"><?php echo e($ride?->start_time); ?> | <span
                                                ...
                                                class="common-color"><?php echo e($ride->dropped_at); ?></span></span></p>
                                ...
                                <div class="vehicle">
                                    ...
                                    <p class="dark-color"><?php echo e(__('taxido::static.invoice.vehicle_type')); ?>: <span
                                            class="common-color"><?php echo e($ride->vehicle_type->vehicle_info->vehicle->name ?? 'N/A'); ?> |</span>
                                        <span class="dark-color">Vehicle Model:</span> <span
                                            class="common-color"><?php echo e($ride?->driver?->vehicle_info['model'] ?? 'N/A'); ?></span>
                                    </p>
                                    <p class="dark-color"><?php echo e(__('taxido::static.invoice.vehicle_number')); ?>:
                                        <span class="common-color"><?php echo e($ride?->driver?->vehicle_info['plate_number'] ?? 'N/A'); ?></span>
                                    </p>
                                </div>
                            </div>
                        </td>
...
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/emails/rider-invoice.blade.php ENDPATH**/ ?>