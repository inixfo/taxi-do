<script async
    src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(getTaxidoSettings()['location']['google_map_api_key'] ?? env('GOOGLE_MAP_API_KEY')); ?>&loading=async&libraries=drawing&callback=initMap">
</script>
...
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/peak-zone-map/google.blade.php ENDPATH**/ ?>