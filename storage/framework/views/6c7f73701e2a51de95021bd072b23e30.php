<?php if(isset($document)): ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="doc-detail">
                            <div class="doc-img">
                                <img src="<?php echo e($document?->document_image?->original_url ?? asset('images/avtar/16.jpg')); ?>"
                                    alt="user">
                            </div>
                        </div>
                    </div>
    ...
    <form method="POST" action="<?php echo e(route('admin.driver-document.updateStatus', $document->id)); ?>" id="statusForm<?php echo e($document->id); ?>">
      <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-start confirmation-data">
                        ...
                        <div class="d-flex">
                            <a type="button" href="<?php echo e(route('admin.driver-document.index')); ?>" class="btn cancel btn-light me-2"><?php echo e(__('taxido::static.wallets.no')); ?></a>
...
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/driver-document/show.blade.php ENDPATH**/ ?>