...
<?php if(isset($categories)): ?>
    <li class="control-section accordion-section add-page" id="add-page">
        <h3 class="accordion-section-title hndle" tabindex="0"> <?php echo e(__('static.categories.categories')); ?><span
                class="screen-reader-text"><?php echo e(__('static.categories.press_return_or_enter_to_expand')); ?></span></h3>
                ...
                <div id="tabs-panel-posttype-post-most-recent" class="tabs-panel tabs-panel-active menu-item-tab"
                    ...
                    <ul class="nav nav-tabs" id="menuItemTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="most-recent-category-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true"><?php echo e(__('static.categories.most_recent')); ?></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="view-all-category-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false"><?php echo e(__('static.categories.view_all')); ?></button>
                        </li>
                    </ul>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $recentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li>
                                        <label class="menu-item-title">
                                            <input data-id="<?php echo e($category?->id); ?>"
                                                id="custom-menu-item-widget-name-<?php echo e($category?->id); ?>" type="checkbox"
                                        ...
                                        <input type="hidden" class="custom-menu-item"
                                            id="custom-menu-item-widget-url-<?php echo e($category?->id); ?>" name="url"
                        ...
                        <div class="tab-pane fade custom-scrollbar" id="view-all-category" role="tabpanel">
                            <ul id="postchecklist-view-all" class="categorychecklist form-no-clear">
                                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li><label class="menu-item-title"><input data-id="<?php echo e($category?->id); ?>"
                                                id="custom-menu-item-widget-name-<?php echo e($category?->id); ?>" type="checkbox"
                                                class="menu-item-checkbox" name="label"
                                                value="<?php echo e($category?->name); ?>"> <?php echo e($category?->name); ?></label><input
                                            type="hidden" class="custom-menu-item"
                                            id="custom-menu-item-widget-url-<?php echo e($category?->id); ?>" name="url"
                                            value="<?php echo e($category?->slug); ?>"></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <li>
                    ...
                    <div class="button-controls">
                        <div class="form-check p-0 float-start">
                            ...
                            <label for="select-all" class="m-0"><?php echo e(__('static.categories.select_all')); ?></label>
                        </div>
                        <a href="javascript:void(0)" onclick="addCustomMenuWidget()"
                            class="button-secondary submit-add-to-menu float-end right">
                            <?php echo e(__('static.categories.add_menu_item')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/taxido/Taxido_laravel/resources/views/admin/category/widget.blade.php ENDPATH**/ ?>