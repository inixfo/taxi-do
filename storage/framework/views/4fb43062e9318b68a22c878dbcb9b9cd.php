        ...
        <div class="inside">
            ...
            <div class="button-container mb-3 d-flex justify-content-start">
                <?php $__empty_1 = true; $__currentLoopData = $eventAndShortcodes['shortcodes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shortcode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <button class="btn btn-primary me-2 shortcode-button" data-text="<?php echo e($shortcode['action']); ?>">
                        <?php echo e($shortcode['text']); ?>
            ...
            <div>
                ...
                <form method="POST" id="smsTemplatesForm" action="<?php echo e(route('admin.sms-template.update', @$slug)); ?>"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/resources/views/admin/sms-template/template.blade.php ENDPATH**/ ?>