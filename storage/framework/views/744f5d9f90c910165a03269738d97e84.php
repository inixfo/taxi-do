<?php $__env->startSection('title', __('taxido::static.fleet_vehicles.fleet_vehicles')); ?>
            ...
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    ...
                    <div class="subtitle-button-group">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vehicle_info.create')): ?>
                            <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.vehicle-info.create')); ?>">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/vehicle-info/index.blade.php ENDPATH**/ ?>