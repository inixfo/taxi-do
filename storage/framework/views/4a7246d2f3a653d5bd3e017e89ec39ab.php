    ...
    <div class="inside">
        ...
        <div class="wallet-detail">
            <div class="wallet-detail-content">
                ...
                <?php if(Auth::user()->hasRole(RoleEnum::ADMIN) || Auth::user()?->can('fleet_wallet.credit') || Auth::user()?->can('fleet_wallet.debit')): ?>
                    <form action="<?php echo e(route('admin.fleet-wallet.update.balance')); ?>" method="POST" id="fleet-wallet"
                        class="wallet-form">
                        <?php echo csrf_field(); ?>
                        <input class="form-control fleetId" type="hidden" name="fleet_manager_id"
                            value="<?php echo e(request()->query('fleet_manager_id')); ?>" placeholder="+ ">
                        <div class="form-group row">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fleet_wallet.credit')): ?>
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fleet_wallet.debit')): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/fleet-wallet/amount.blade.php ENDPATH**/ ?>