                    ...
                    <div class="form-group row">
                        <?php if(isset($label)): ?>
                            <label class="col-md-2"
                                for="name"><?php echo e(__('taxido::static.wallets.balance')); ?><span>*</span></label>
                        <?php endif; ?>
                        <div class="col-md-10">
                            <h4 id="balanceLabel"><?php echo e(isset($balance) ? formatCurrency((float) $balance) : '0.00'); ?></h4>
                        </div>
                    </div>
                </div>

                <?php if(Auth::user()->hasRole(RoleEnum::ADMIN) || Auth::user()?->can('rider_wallet.credit') || Auth::user()?->can('rider_wallet.debit')): ?>
                    <form action="<?php echo e(route('admin.rider-wallet.update.balance')); ?>" method="POST" id="rider-wallet"
                        class="wallet-form">
                        <?php echo csrf_field(); ?>
                        <input class="form-control riderId" type="hidden" name="rider_id"
                            value="<?php echo e(request()->query('rider_id')); ?>" placeholder="+ ">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rider_wallet.credit')): ?>
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rider_wallet.debit')): ?>
                                    ...
                                    <div class="modal-body text-start confirmation-data">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn cancel btn-light me-2"
                                                data-bs-dismiss="modal"><?php echo e(__('taxido::static.wallets.no')); ?></button>
                                            <button type="submit"
                                                class="btn btn-primary delete delete-btn spinner-btn"><?php echo e(__('taxido::static.wallets.yes')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/rider-wallet/amount.blade.php ENDPATH**/ ?>