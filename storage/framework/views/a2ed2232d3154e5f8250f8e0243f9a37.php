                ...
                <div class="row g-md-4 g-3">
                        ...
                        <div class="left-map-box">
                            <div class="save-address-map-box">
                                <div class="alert alert-warning">
                                    Ride requests from the admin and web currently support only on-demand cab services. Bidding rides are not supported - please ensure bidding is disabled in <a href="<?php echo e(route('admin.taxido-setting.index')); ?>">App Settings</a>.
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="rider_id"><?php echo e(__('taxido::static.rides.rider')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select form-select-transparent select2-option" name="rider_id"
                                    id="rider_id" data-placeholder="<?php echo e(__('taxido::static.wallets.select_rider')); ?>">
                                    <option></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="service_id"><?php echo e(__('taxido::static.rides.service')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select id="service_id" class="form-select form-select-transparent select2-option"
                                    name="service_id" data-placeholder="<?php echo e(__('taxido::static.rides.select_service')); ?>">
                                    <option></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 service-category-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="service_category_id"><?php echo e(__('taxido::static.rides.service_category')); ?><span>*</span></label>
                            <div class="col-12 select-item">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="pickup-location-div">
                        <div class="form-group row">
                            <label class="col-12" for="locations"><?php echo e(__('taxido::static.rides.pickup_location')); ?></label>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="destination-location-div">
                        <div class="form-group row">
                            <label for="destination" class="form-label"><?php echo e(__('taxido::static.rides.destination_location')); ?></label>
                    ...
                    <div class="col-xl-8" id="rental-locations-form" style="display: none;">
                        <div class="form-group row">
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_pickup_location"><?php echo e(__('taxido::static.rides.pickup_location')); ?><span>*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_destination_location"><?php echo e(__('taxido::static.rides.destination_location')); ?><span>*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="packages-list-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="package_id"><?php echo e(__('taxido::static.rides.hourly_package')); ?><span>*</span></label>
                            <div class="col-12 select-item">
...
unset($__errorArgs, $__bag); ?>
                                <span class="text-gray">
                                    <?php echo e(__('taxido::static.hourly_package.no_hourly_package_message')); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="start-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="start_time"><?php echo e(__('taxido::static.rides.start_date_time')); ?><span>*</span></label>
                            <div class="col-12">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="end-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="end_time"><?php echo e(__('taxido::static.rides.end_date_time')); ?><span>*</span></label>
                            <div class="col-12">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 vehicle-type-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="vehicle_type_id"><?php echo e(__('taxido::static.rides.vehicle_type')); ?><span>*</span></label>
                            <div class="col-12 select-item">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="driver_assign"><?php echo e(__('taxido::static.rides.driver_assign')); ?> </label>
                            <div class="col-12">
                                <div class="switch-field form-control">
                                    <input value="automatic" type="radio" name="driver_assign" id="driver_assign_automatic"/>
                                    <label for="driver_assign_automatic"><?php echo e(__('taxido::static.rides.automatic')); ?></label>
                                    <input value="manual" type="radio" name="driver_assign" id="driver_assign_manual" checked/>
                                    <label for="driver_assign_manual"><?php echo e(__('taxido::static.rides.manual')); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="drivers_div"  style="display: block;">
                        <div class="form-group row">
                            <label for="driver"
                                class="col-12"><?php echo e(__('taxido::static.rides.driver')); ?><span>*</span></label>
                            <div class="col-12">
                                <select class="select-2 form-control driver-control" id="driver" name="driver"
                                    data-placeholder="<?php echo e(__('taxido::static.rides.select_driver')); ?>">
                                    <option></option>
                                </select>
                                <span id="no-drivers-message" class="text-danger" style="display: none;">
                                    <?php echo e(__('taxido::static.rides.no_drivers_found')); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="cargo_image_div" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12" for="cargo_image_id">
                                <?php echo e(__('taxido::static.rides.cargo_image')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['text' => __('static.svg_not_supported'),'unallowedTypes' => ['svg'],'name' => 'cargo_image_id','data' => old('cargo_image_id'),'multiple' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('static.svg_not_supported')),'unallowed_types' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['svg']),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('cargo_image_id'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('cargo_image_id')),'multiple' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="rental-vehicle" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="rental_vehicle"><?php echo e(__('taxido::static.rides.rental_vehicle')); ?><span>*</span></span></label>
                            <div class="col-12 select-item">
                                <select class="form-control select-2" name="rental_vehicle_id" id="rental_vehicle_id"
                                    data-placeholder="<?php echo e(__('taxido::static.drivers.select_rental_vehicle')); ?>">
                                    <option></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                                <span id="rental-slug-loader" class="spinner-border ride-loader" role="status"
                                    style="display: none;"></span>
                                <span class="text-gray">
                                    <?php echo e(__('taxido::static.drivers.no_rental_message')); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12" for="name">
                                        <?php echo e(__('taxido::static.rides.receiver_full_name')); ?><span>*</span>
                                    </label>
                                    <div class="col-12">
                                        <input class="form-control" type="text" id="parcel_receiver[name]"
                                            name="parcel_receiver[name]"
                                            placeholder="<?php echo e(__('taxido::static.rides.enter_receiver_full_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="phone"><?php echo e(__('taxido::static.rides.receiver_phone')); ?><span>*</span></label>
                                    <div class="col-12">
                                        <div class="input-group mb-3 phone-detail row g-0 phone-details-2">
                                            ...
                                            <div class="col-sm-11">
                                                <input class="form-control" type="number"
                                                    ...
                                                    placeholder="<?php echo e(__('taxido::static.rides.enter_receiver_phone')); ?>">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="ambulance_div" style="display:none">
                        <div class="form-group row">
                            <label class="col-12"
                                for="ambulance_id"><?php echo e(__('taxido::static.rides.ambulance')); ?><span>*</span></label>
                            <div class="col-12 select-item">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row" id="with-driver-container" style="display: none;">
                        <label class="col-md-2" for="with_driver"><?php echo e(__('taxido::static.rental_vehicle.with_driver')); ?></label>
                        <div class="col-md-10">
                            <label class="switch">
    ...
    function fetchAndDisplayDrivers(lat, lng, serviceId = null, serviceCategoryId = null, vehicleTypeId = null) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!driversFound) {
                    toastr.warning("<?php echo e(__('taxido::static.rides.no_drivers_found')); ?>", {
                        closeButton: true,
                        progressBar: true,
                        timeOut: 5000
                    });
...
<script>
    (function($) {
            ...
            const newRow = $(`
                    <div class="row g-2 mt-3">
                        <div class="custom-col-md-11 ms-0">
                            <div class="location-row">
                                <input type="text" class="form-control ui-widget autocomplete-google location-input" name="locations[]" placeholder="${isFirstLocation ? '<?php echo e(__('taxido::static.rides.enter_pickup_location')); ?>' : '<?php echo e(__('taxido::static.rides.enter_destination_location')); ?>'}">
        ...
        $('#driver').select2({
            placeholder: "<?php echo e(__('taxido::static.rides.select_driver')); ?>",
            templateSelection: optionFormat,
            templateResult: optionFormat
        });
        ...
        $('form').on('submit', function(event) {
            ...
            if ($('#service_category_id').val() != rentalId && $('#service_id').val() != ambulanceId && !selectedDriver && $('#driver_assign_manual').is(':checked')) {
                ...
                toastr.error("<?php echo e(__('taxido::static.rides.no_driver_selected')); ?>", {
                    closeButton: true,
                    progressBar: true,
                    timeOut: 5000
                });
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/ride/fields.blade.php ENDPATH**/ ?>