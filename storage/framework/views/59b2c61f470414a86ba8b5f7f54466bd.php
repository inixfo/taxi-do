...
<?php use \Modules\Taxido\Models\VehicleInfo; ?>
            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(isset($vehicleInfoDoc) ? __('taxido::static.fleet_vehicle_documents.edit') : __('taxido::static.fleet_vehicle_documents.add')); ?>

                        </h3>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="document_image_id"><?php echo e(__('taxido::static.fleet_vehicle_documents.document_image')); ?><span>
                                *</span></label>
                        <div class="col-md-10">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['name' => 'document_image_id','data' => isset($vehicleInfoDoc->document_image)
                                    ? $vehicleInfoDoc?->document_image
                                    : old('document_image_id'),'text' => '','multiple' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('document_image_id'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($vehicleInfoDoc->document_image)
                                    ? $vehicleInfoDoc?->document_image
                                    : old('document_image_id')),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'multiple' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="fleet_manager_id"><?php echo e(__('taxido::static.fleet_vehicle_documents.fleet_vehicle')); ?>

                            <span> *</span></label>
                        <div class="col-md-10 select-label-error">
                            <span class="text-gray mt-1">
                                <?php echo e(__('taxido::static.fleet_vehicle_documents.add_fleet_message')); ?>

                                <a href="<?php echo e(route('admin.vehicle-info.index')); ?>" class="text-primary">
                                    <b><?php echo e(__('taxido::static.here')); ?></b>
                                </a>
                            </span>
                            <select id="select-fleet" class="form-control select-2 fleet" name="vehicle_info_id"
                                data-placeholder="<?php echo e(__('taxido::static.fleet_vehicle_documents.select_fleet')); ?>">
                                <option></option>
                                <?php $__currentLoopData = $vehicleInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($vehicle->id); ?>"
                                        <?php if(old('vehicle_info_id', @$vehicleInfoDoc->vehicle_info_id) == $vehicle->id): echo 'selected'; endif; ?>>
                                        <?php echo e($vehicle->name); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['vehicle_info_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="document_id"><?php echo e(__('taxido::static.fleet_vehicle_documents.document')); ?><span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">

                            <?php if(getCurrentRoleName() == RoleEnum::ADMIN): ?>
                                <span class="text-gray mt-1">
                                    <?php echo e(__('taxido::static.fleet_vehicle_documents.no_documents_message')); ?>
                            ...
                            <select class="form-control select-2 document" name="document_id"
                                data-placeholder="<?php echo e(__('taxido::static.fleet_vehicle_documents.select_document')); ?>">
                                ...
                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($document->id); ?>"
                                        ...
                                        <?php if(@$vehicleInfoDoc): ?> <?php if(old('document_id', @$vehicleInfoDoc?->document_id) == $document->id): echo 'selected'; endif; ?> <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row flatpicker-calender select-date">
                        ...
                        <div class="col-md-10">
                            <?php if(isset($vehicleInfoDoc) && $vehicleInfoDoc->expired_at): ?>
                                <input class="form-control" id="expired_at"
                                    value="<?php echo e(\Carbon\Carbon::parse($vehicleInfoDoc->expired_at)->format('m/d/Y')); ?>"
                    ...
                    <?php if(getCurrentRoleName() == RoleEnum::ADMIN): ?>
                        <div class="form-group row">
                            <label for="status" class="col-md-2">
                                <?php echo e(__('taxido::static.fleet_vehicle_documents.status')); ?><span>*</span>
                            </label>
                            <div class="col-md-10 select-label-error">
                                <select class="select-2 form-control" id="status" name="status"
                                    data-placeholder="<?php echo e(__('taxido::static.fleet_vehicle_documents.select_status')); ?>">
                                    <option class="option" value="" selected></option>
                                    <option value="pending" <?php if(old('status', @$vehicleInfoDoc?->status) == 'pending'): echo 'selected'; endif; ?>>
                                        <?php echo e(__('taxido::static.fleet_vehicle_documents.pending')); ?>

                                    </option>
                                    <option value="approved" <?php if(old('status', @$vehicleInfoDoc?->status) == 'approved'): echo 'selected'; endif; ?>>
                                        <?php echo e(__('taxido::static.fleet_vehicle_documents.approved')); ?>

                                    </option>
                                    <option value="rejected" <?php if(old('status', @$vehicleInfoDoc?->status) == 'rejected'): echo 'selected'; endif; ?>>
                                        <?php echo e(__('taxido::static.fleet_vehicle_documents.rejected')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/vehicle-info-doc/fields.blade.php ENDPATH**/ ?>