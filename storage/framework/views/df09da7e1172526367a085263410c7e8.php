<?php $__env->startSection('title', __('ticket::static.executive.executive')); ?>
<?php $__env->startSection('content'); ?>
<div class="contentbox">
    <div class="inside">
        <div class="contentbox-title">
            <div class="contentbox-subtitle">
                <h3><?php echo e(__('ticket::static.executive.support_executive')); ?></h3>
                <div class="subtitle-button-group">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ticket.executive.create')): ?>
                        <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.executive.create')); ?>">
                            <i class="ri-add-line"></i><?php echo e(__('ticket::static.executive.add_new')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Ticket/resources/views/admin/executive/index.blade.php ENDPATH**/ ?>