...
<?php $__env->startSection('title', "Ride Tracking - $ride->ride_number ?? '' "); ?>
            ...
            <div class="ride-header" id="rideHeader">
                <div class="ride-status-indicator">
                    ...
                    <span class="badge" id="ride-status">
                        <?php echo e(ucfirst($ride->ride_status['name'] ?? 'Unknown')); ?>

                    </span>
                </div>

                <div class="ride-number" id="ride-number">
                    #<?php echo e($ride->ride_number ?? ''); ?>

                </div>

                <?php if($ride->otp): ?>
                    <div class="badge badge-info" id="otp">
                        OTP: <?php echo e($ride->otp); ?>
            ...
            <div class="status-activities">
                ...
                <div class="timeline" id="timeline-activities">
                    ...
                    <?php if($hasActivities): ?>
                        <?php $__currentLoopData = $activities->sortBy('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <div class="timeline-item <?php echo e($isCurrent ? 'current' : ''); ?>">
                                <div class="timeline-marker bg-success"></div>
                                <div class="timeline-content">
                                    <div>
                                        <div class="timeline-status"><?php echo e(ucfirst(str_replace('_', ' ', $statusName))); ?></div>
                                        <div class="timeline-description"></div>
                                    </div>
                                    <div class="timeline-time">
                                        <?php echo e(\Carbon\Carbon::parse($statusTime)->format('M j, g:i A')); ?></div>
                                </div>
                            </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="timeline-item current">
                            ...
                            <div class="timeline-content">
                                <div>
                                    <div class="timeline-status"><?php echo e(ucfirst(str_replace('_', ' ', $currentStatus))); ?></div>
                                    <div class="timeline-description">Current ride status</div>
                                </div>
                                <div class="timeline-time"><?php echo e(now()->format('M j, g:i A')); ?></div>
                            </div>
                        </div>
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-time">
                                    <?php echo e(\Carbon\Carbon::parse($ride->created_at)->format('M j, g:i A')); ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="info-section">
                <ul class="info-list">
                    <li>
                        ...
                        <span class="info-value"><?php echo e(count($locations)); ?></span>
                    </li>
                    <li>
            ...
            <div class="accordion-section">
                ...
                <div id="riderCollapse" class="accordion-collapse collapse" data-bs-parent="#rideDetailsAccordion">
                    <div class="accordion-body">
                        <div class="info-section">
                            <div class="user-info">
                                <?php if(isset($ride?->rider['profile_image_url'])): ?>
                                    <img class="user-avatar" id="rider-profile-img"
                                        src="<?php echo e($ride?->rider['profile_image_url']); ?>"
                                        alt="<?php echo e($ride?->rider['name'] ?? 'Rider'); ?>">
                                <?php else: ?>
                                    <div class="user-initial" id="rider-initial-letter">
                                        <?php echo e(strtoupper(substr($ride?->rider['name'] ?? 'R', 0, 1))); ?>

                                    </div>
                                <?php endif; ?>

                                <div class="user-details">
                                    <h4 id="rider-name"><?php echo e($ride?->rider['name'] ?? 'Unknown Rider'); ?></h4>
                                    <div class="user-rating">
                                        <i class="ri-star-fill"></i>
                                        <span id="rider-rating"><?php echo e($ride?->rider['rating_count'] ?? '0'); ?></span>
                                    </div>
                                </div>
                            </div>

                            <ul class="info-list">
                                <?php if(isset($ride?->rider['email']) && !isDemoModeEnabled()): ?>
                                    <li>
                                        <span class="info-label">Email</span>
                                        <span class="info-value"
                                            id="rider-email"><?php echo e($ride?->rider['email'] ?? 'N/A'); ?></span>
                                    </li>
                                <?php endif; ?>

                                <?php if(isset($ride?->rider['country_code']) && isset($ride?->rider['phone']) && !isDemoModeEnabled()): ?>
                                    <li>
                                        <span class="info-label">Phone</span>
                                        <span class="info-value" id="rider-phone">
                                            +<?php echo e($ride?->rider['country_code'] ?? ''); ?> <?php echo e($ride?->rider['phone'] ?? ''); ?>
                            ...
                            <div class="user-info">
                                <?php if(isset($ride?->driver['profile_image_url'])): ?>
                                    <img class="user-avatar" id="driver-profile-img"
                                        ...
                                        alt="<?php echo e($ride?->driver['name'] ?? 'Driver'); ?>">
                                <?php else: ?>
                                    <div class="user-initial" id="driver-initial-letter">
                                        <?php echo e(strtoupper(substr($ride?->driver['name'] ?? 'D', 0, 1))); ?>

                                    </div>
                                <?php endif; ?>

                                <div class="user-details">
                                    <h4 id="driver-name"><?php echo e($ride?->driver['name'] ?? 'Unknown Driver'); ?></h4>
                                    <div class="user-rating">
                                        <i class="ri-star-fill"></i>
                                        <span id="driver-rating"><?php echo e($ride?->driver['rating_count'] ?? '0'); ?></span>
                                    </div>
                                </div>
                            </div>

                            <ul class="info-list">
                                <?php if(isset($ride?->driver['email']) && !isDemoModeEnabled()): ?>
                                    <li>
                                        <span class="info-label">Email</span>
                                        <span class="info-value"
                                            id="driver-email"><?php echo e($ride?->driver['email'] ?? 'N/A'); ?></span>
                                    </li>
                                <?php endif; ?>

                                <?php if(isset($ride?->driver['country_code']) && isset($ride?->driver['phone']) && !isDemoModeEnabled()): ?>
                                    <li>
                                        <span class="info-label">Phone</span>
                                        <span class="info-value" id="driver-phone">
                                            +<?php echo e($ride?->driver['country_code'] ?? ''); ?>

                                            <?php echo e($ride?->driver['phone'] ?? ''); ?>
                        ...
                        <div class="info-section">
                            <ul class="info-list">
                                <li>
                                    ...
                                    <span class="info-value"
                                        id="service-name"><?php echo e($ride->service['name'] ?? 'N/A'); ?></span>
                                </li>
                                <li>
                                    <span class="info-label">Service Category</span>
                                    <span class="info-value"
                                        id="service-category-name"><?php echo e($ride->service_category['name'] ?? 'N/A'); ?></span>
                                </li>
                                <li>
                                    <span class="info-label">Distance</span>
                                    <span class="info-value" id="ride-distance"><?php echo e($ride?->distance ?? '0'); ?>

                                        <?php echo e($ride?->distance_unit ?? 'km'); ?></span>
                                </li>
                                <?php if(isset($ride->service['slug']) &&
                                    ...
                                    <li>
                                        ...
                                        <span class="info-value" id="weight"><?php echo e($ride?->weight ?? 'N/A'); ?></span>
                                    </li>
                                <?php endif; ?>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span class="info-value">
                                        <span class="badge-warning" id="payment-status">
                                            <?php echo e(ucfirst(strtolower($ride->payment_status ?? 'Pending'))); ?>
                        ...
                        <div class="info-section">
                            <ul class="info-list">
                                <li>
                                    ...
                                    <span class="info-value"
                                        id="ride-fare-detail"><?php echo e($cs . number_format(round($ride->ride_fare ?? 0, 2), 2)); ?></span>
                                </li>

                                <?php if(($ride->additional_distance_charge ?? 0) > 0): ?>
                                    <li>
                                ...
                                <?php if(($ride->additional_minute_charge ?? 0) > 0): ?>
                                    <li>
                                ...
                                <?php if(($ride->additional_weight_charge ?? 0) > 0): ?>
                                    <li>
                                ...
                                <?php if(($ride->waiting_charges ?? 0) > 0): ?>
                                    <li>
                                ...
                                <?php if(($ride->bid_extra_amount ?? 0) > 0): ?>
                                    <li>
                                ...
                                <li class="price-total">
                                    ...
                                    <span class="info-value"
                                        id="subtotal"><?php echo e($cs . number_format(round($ride->sub_total ?? 0, 2), 2)); ?></span>
                                </li>

                                <li>
                                    <span class="info-label">Platform Fee</span>
                                    <span class="info-value"
                                        id="platform-fees"><?php echo e($cs . number_format(round($ride->platform_fees ?? 0, 2), 2)); ?></span>
                                </li>
                                <li>
                                    <span class="info-label">Tax</span>
                                    <span class="info-value"
                                        id="tax"><?php echo e($cs . number_format(round($ride->tax ?? 0, 2), 2)); ?></span>
                                </li>
                                <li>
                                    <span class="info-label">Admin Commission</span>
                                    <span class="info-value"
                                        id="admin-commission"><?php echo e($cs . number_format(round($ride->commission ?? 0, 2), 2)); ?></span>
                                </li>

                                <li class="price-total price-success">
                                    <span class="info-label">Total Bill</span>
                                    <span class="info-value"
                                        id="total-bill"><?php echo e($cs . number_format(round($ride->total ?? 0, 2), 2)); ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if($settings['location']['map_provider'] == 'google_map'): ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($settings['location']['google_map_api_key'] ?? env('GOOGLE_MAP_API_KEY')); ?>&libraries=geometry,places,marker&v=beta"></script>
    ...
    <script>
        ...
        (function() {
            ...
            const CONFIG = {
                rideId: <?php echo e($ride->id); ?>,
                driverId: <?php echo e($ride->driver_id ?? 'null'); ?>,
                mapProvider: '<?php echo e($settings['location']['map_provider']); ?>',
                currencySymbol: '<?php echo e($cs); ?>',
                locationCoordinates: <?php echo json_encode($locationCoordinates, 15, 512) ?>,
                locations: <?php echo json_encode($locations, 15, 512) ?>,
                startRideLocation: <?php echo json_encode($ride->start_ride_locations ?? [], 15, 512) ?>,
                startRideCoordinates: <?php echo json_encode($ride->start_ride_coordinates ? $ride->start_ride_coordinates[0] : null, 15, 512) ?>,
                defaultVehicleImage: '<?php echo e(asset('images/Frame.png')); ?>',
                defaultImage: '<?php echo e(asset('images/user.png')); ?>',
                firebase: {
...
<?php echo $__env->make('front.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/front/ride/track.blade.php ENDPATH**/ ?>