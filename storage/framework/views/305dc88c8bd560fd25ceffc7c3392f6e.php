            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(isset($ticket) ? __('ticket::static.ticket.edit') : __('ticket::static.ticket.add')); ?>
                    ...
                    <?php if(!isset($ticket)): ?>
                        <div class="form-group row">
                            <label class="col-md-2" for="user_ids"><?php echo e(__('ticket::static.ticket.user')); ?><span>*</span></label>
                            <div class="col-md-10 select-label-error">
                                <select class="select-2 form-control" name="user_ids[]" data-placeholder="<?php echo e(__('ticket::static.ticket.select_user')); ?>" multiple>
                                    <option class="select-placeholder" value=""></option>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($user->email !== getCurrentUser()->email): ?>
                                            <option value="<?php echo e($user->id); ?>" class="option"><?php echo e($user->email); ?></option>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2" for="subject"><?php echo e(__('ticket::static.ticket.subject')); ?><span>
                                    *</span></label>
                            <div class="col-md-10">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2" for="description"><?php echo e(__('ticket::static.ticket.description')); ?><span>
                                    *</span></label>
                            <div class="col-md-10 select-label-error">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php $__currentLoopData = $formFeilds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formFeild): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($formFeild->type == 'text'): ?>
                                <div class="form-group row">
                                    <label class="col-md-2" for="<?php echo e('other_' . $formFeild->name); ?>"><?php echo e($formFeild->label); ?> <?php if($formFeild->is_required): ?>
                                            <span> *</span>
                                        <?php endif; ?>
                                    </label>
                                    <div class="col-md-10">
                            ...
                            <?php if($formFeild->type == 'textarea'): ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control" name="<?php echo e('other_' . $formFeild->name); ?>"
                            ...
                            <?php if($formFeild->type == 'select'): ?>
                                <div class="form-group row">
                                    <label class="col-md-2" for="select"><?php echo e($formFeild->label); ?><?php if($formFeild->is_required): ?>
                                            <span> *</span>
                                        <?php endif; ?>
                                    </label>
                                    <div class="col-md-10 select-label-error">
                                        <select class="select-2 form-control"
                                            name="<?php if($formFeild->select_type == 'multiple_select'): ?> <?php echo e('other_' . $formFeild->name . '[]'); ?> <?php else: ?> <?php echo e('other_' . $formFeild->name); ?> <?php endif; ?>"
                                            data-placeholder="<?php echo e($formFeild->placeholder); ?>"
                            ...
                            <?php if($formFeild->type == 'checkbox'): ?>
                                <div class="form-group row">
                                    <label class="col-md-2" for="checkbox"><?php echo e($formFeild->label); ?><?php if($formFeild->is_required): ?>
                                            <span> *</span>
                                        <?php endif; ?>
                                    </label>
                                    <div class="col-md-10">
                            ...
                            <?php if($formFeild->type == 'radio'): ?>
                                <div class="form-group row">
                                    <label class="col-md-2" for="radio"><?php echo e($formFeild->label); ?><?php if($formFeild->is_required): ?>
                                            <span> *</span>
                                        <?php endif; ?>
                                    </label>
                                    <div class="col-md-10">
                                        <?php $__currentLoopData = $formFeild->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group m-checkbox-inline mb-0 d-flex">
                                                <input type="radio" name="<?php echo e('other_' . $formFeild->name); ?>"
                                                    value="<?php echo e($option['option_value']); ?>"><?php echo e($option['option_name']); ?>
                    ...
                    <?php if(isset($departments)): ?>
                        <div class="form-group row">
                            <label class="col-md-2" for="department_id"><?php echo e(__('ticket::static.ticket.department')); ?><span>
                                    *</span></label>
                            <div class="col-md-10 select-label-error">
                                 <span class="text-gray mt-1">
                                        <?php echo e(__('ticket::static.ticket.no_department_message')); ?>

                                        <a href="<?php echo e(@route('admin.department.index')); ?>" class="text-primary">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(isset($priorities)): ?>
                        <div class="form-group row">
                            <label class="col-md-2" for="priority_id"><?php echo e(__('ticket::static.ticket.priority')); ?><span>
                                    *</span></label>
                            <div class="col-md-10 select-label-error">
                                <span class="text-gray mt-1">
                                        <?php echo e(__('ticket::static.ticket.no_priority_message')); ?>

                                        <a href="<?php echo e(@route('admin.priority.index')); ?>" class="text-primary">
                                            <b><?php echo e(__('ticket::static.here')); ?></b>
                                        </a>
                                    </span>
                    ...
                    <?php if(!isset($ticket)): ?>
                        <div class="form-group row">
                            <label class="col-md-2"
                                for="image"><?php echo e(__('ticket::static.ticket.attachment')); ?></label>
                            <div class="col-md-10">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Ticket/resources/views/admin/ticket/fields.blade.php ENDPATH**/ ?>