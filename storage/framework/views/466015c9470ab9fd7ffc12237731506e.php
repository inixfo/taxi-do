<?php $__env->startSection('title', __('ticket::static.tags.tags')); ?>
<?php $__env->startSection('content'); ?>
<div class="row ga- category-main g-md-4 g-3">
    <div class="col-xl-4">
        <div class="p-sticky">
            <form id="tagForm" action="<?php echo e(route('admin.ticket.tag.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('ticket::admin.tag.fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </form>
        </div>
    </div>
    <div class="col-xl-8">
        <div class="contentbox">
            <div class="inside">
                <div class="contentbox-title">
                    <h3><?php echo e(__('ticket::static.tags.tags')); ?></h3>
                </div>
                <div class="tag-table">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Ticket/resources/views/admin/tag/index.blade.php ENDPATH**/ ?>