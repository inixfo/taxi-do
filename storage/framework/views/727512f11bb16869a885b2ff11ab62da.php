...
unset($__errorArgs, $__bag); ?>
                                    <div class="col-sm-12-full">
                                        <input type="number" class="form-control" name="email_or_phone" id="email_or_phone"
                                            placeholder="<?php echo e(__('taxido::front.enter_phone_number')); ?>" value="<?php echo e(old('email_or_phone')); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if(isset($settings['activation']['default_credentials'])): ?>
                                ...
                                <button type="button" class="btn btn-outline default-credentials guest-btn" data-email="0123456789">
                                    ...
                                    <?php echo e(__('taxido::front.demo_user')); ?>
                ...
                if (isEmail) {
                    ...
                    signInWithPhoneNumber(auth, phoneNumber, recaptchaVerifier)
                        .then((result) => {
                            ...
                            toastr.success("<?php echo e(__('taxido::front.otp_sent_in_phone')); ?>");
                            $('#otp-code').val('');
                            $('#select-country-code').prop('disabled', true);
                            $('#email_or_phone').attr('readonly', true);
                            $('#generate_otp').hide();
            ...
            $('#verify_otp').click(function() {
                ...
                if (isEmail) {
                    ...
                    if (!confirmationResult) {
                        toastr.error("<?php echo e(__('taxido::front.request_otp')); ?>");
                        return;
                    }
                    ...
                    confirmationResult.confirm(code)
                        .then((result) => {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('front.cab.firebase.verify-otp')); ?>",
                                method: 'POST',
                                data: credentials,
                        ...
                        .catch((error) => {
                            ...
                            toastr.error("<?php echo e(__('taxido::front.invalid_otp')); ?>");
...
<?php echo $__env->make('front.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/front/auth/firebase-login-with-number.blade.php ENDPATH**/ ?>