...
<?php use \Modules\Taxido\Models\HourlyPackage; ?>
<?php
...
<?php $__env->startSection('title', __('taxido::static.ride.index')); ?>
...
<!-- Toastr css -->
<link rel="stylesheet" as="style" href="<?php echo e(asset('admin/css/vendors/toastr.min.css')); ?>" media="print" onload="this.media='all'">
<?php $__env->stopPush(); ?>
      ...
      <div class="row g-md-4 g-3">
        <div class="col-12">
          <div class="alert alert-message alert-dismissible" role="alert">
              <span><i class="ri-alert-fill"></i> <?php echo e(__('taxido::front.rides.warning_note')); ?></span>
          ...
          <div class="left-map-box">
            <div class="save-address-map-box">
              <div class="">
                ...
                <div id="map-placeholder" style="display: none; height: 500px; width: 100%; background-color: #f0f0f0; text-align: center; padding-top: 200px;">
                  <p style="font-size: 18px; color: #333;">
                    <?php echo e(__('taxido::front.rides.location_permission_denied')); ?><br>
                    <small><?php echo e(__('taxido::front.rides.allow_location_permission')); ?></small>
                  </p>
              ...
              <ul class="duration-distance-box">
                <li><?php echo e(__('taxido::front.rides.duration')); ?>: <span id="duration">00 Min</span></li>
                <li><?php echo e(__('taxido::front.rides.distance')); ?>: <span id="distance-label">0.00 KM</span></li>
        ...
        <div class="col-lg-7">
          <div class="right-details-box">
            <div class="dashboard-title">
              <h3><?php echo e(__('taxido::front.rides.ride_booking')); ?></h3>
            </div>
            ...
            <div class="row g-sm-4 g-3">
              ...
              <div class="col-xl-6 col-lg-12 col-md-6">
                <div class="form-box">
                  <label class="form-label"><?php echo e(__('taxido::static.rides.service')); ?><span class="text-danger">*</span></label>
                  <div class="select-item">
                    <select id="service_id" class="form-select form-select-transparent select2-option" data-placeholder="<?php echo e(__('taxido::static.rides.select_service')); ?>">
                      <option></option>
              ...
              <div class="col-xl-6 col-lg-12 col-md-6">
                <div class="form-box service-category-container">
                  <label class="form-label"
                    for="service_category_id"><?php echo e(__('taxido::static.rides.service_category')); ?><span class="text-danger">*</span></label>
                  <div class="select-item">
                    <select class="form-select form-select-transparent select2-option"
                      data-placeholder="<?php echo e(__('taxido::static.rides.select_service_category')); ?>"
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-xl-6 col-lg-12 col-md-6" id="ambulance_div" style="display:none">
                <div class="form-group row">
                  <label class="col-12" for="ambulance_id"><?php echo e(__('taxido::static.rides.ambulance')); ?><span class="text-danger">*</span></label>
                  <div class="col-12 select-item">
                    <select class="form-select select-2" name="ambulance_id"
                      id="ambulance_id" data-placeholder="<?php echo e(__('taxido::static.rides.select_ambulance')); ?>">
                      <option></option>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-xl-6 col-lg-12 col-md-6" id="pickup-location-div">
                <div class="form-box">
                  <label for="pickUp" class="form-label"><?php echo e(__('taxido::front.rides.pick_up_location')); ?></label>
                  <div class="location-row">
                    <input type="text" id="pickup-input" name="locations[]"
                      ...
                      placeholder="<?php echo e(__('taxido::static.rides.enter_pickup_location')); ?>">
              ...
              <div class="col-xl-6 col-lg-12 col-md-6" id="destination-location-div">
                <div class="form-box">
                  <label for="destination" class="form-label"><?php echo e(__('taxido::front.rides.destination_location')); ?></label>
                  <div class="col-12" id="destination-location-container">
                    <div class="location-row">
                      <input type="text" id="destination-input" name="locations[]"
                        class="form-control white-from-control ui-widget autocomplete-google location-input"
                        placeholder="<?php echo e(__('taxido::static.rides.enter_destination_location')); ?>">
              ...
              <div class="col-12" id="start-time-field" style="display: none;">
                ...
                <div class="start-time-container">
                  <div class="form-box">
                    <label class="form-label" for="start_time"><?php echo e(__('taxido::static.rides.end_date_time')); ?><span class="text-danger">*</span></label>
                    <input id="start_time" class="form-control white-from-control flatpickr" type="datetime-local"
                      placeholder="<?php echo e(__('taxido::static.rides.select_end_date_and_time')); ?>"
                      name="start_time" />
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-12" id="hourly-packages-list-container" style="display: none;">
                ...
                <div class="hourly-packages-list-container">
                  <div class="form-box">
                    <label class="form-label"
                      for="package_id"><?php echo e(__('taxido::static.rides.hourly_package')); ?><span class="text-danger">*</span></label>
                    <div class="select-item">
                      <select id="hourly_package_id" class="form-control select-2" name="hourly_package_id"
                        data-placeholder="<?php echo e(__('taxido::static.rides.select_package')); ?>">
                        <option></option>
                        <?php $__currentLoopData = $hourlyPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hourlyPackage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($hourlyPackage->id); ?>">
                            <?php echo e($hourlyPackage->hour); ?> hour - <?php echo e($hourlyPackage->distance); ?> <?php echo e($hourlyPackage->distance_type); ?>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-12" id="select_vehicle_type_box">
                ...
                <div class="select-vehicles-box vehicle-type-slider-container">
                  <label class="form-label"><?php echo e(__('taxido::front.select_vehicle_type')); ?></label>
                  <div class="swiper mySwiper vehicle-slider-box">
                    <div class="vehicle-spinner-box" id="vehicleTypeBoxSpinner" style="display: none;">
                      <div class="spinner-border">
                        <span class="visually-hidden"><?php echo e(__('taxido::front.rides.loading')); ?></span>
                      </div>
                    </div>
              ...
              <div class="col-12">
                <div class="form-box">
                  <label for="note" class="form-label"><?php echo e(__('taxido::front.rides.note')); ?></label>
                  <div class="location-row" id="location-container">
                    <textarea class="form-control white-from-control" name="description" rows="4" cols="100" placeholder="<?php echo e(__('taxido::front.rides.write_note')); ?>"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                <button type="button" id="bookRideBtn" class="btn confirm-btn gradient-bg-color">
                  <span role="status"><?php echo e(__('taxido::front.rides.book_ride')); ?></span>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="cancel-ride-box">
          ...
          <p><?php echo e(__('taxido::front.rides.find_driver_note')); ?></p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="cancelRideBtn"><?php echo e(__('taxido::front.rides.cancel_ride')); ?></button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered custom-width">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><?php echo e(__('taxido::front.rides.ride_book_successfully')); ?></h3>
      ...
      <div class="modal-body">
        <div class="ride-success-box">
          ...
          <p><?php echo e(__('taxido::front.rides.sent_request')); ?></p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn gradient-bg-color w-100" data-bs-dismiss="modal"><?php echo e(__('taxido::front.rides.okay')); ?></button>
      </div>
    </div>
  </div>
</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($settings['location']['google_map_api_key'] ?? env('GOOGLE_MAP_API_KEY')); ?>&libraries=places,geometry,drawing&callback=initMap" defer></script>
...
<script>
    ...
    if (pickupLatLng && destinationLatLng && directionsService && directionsRenderer) {
      ...
      directionsService.route(request, function(result, status) {
        ...
        if (status === 'OK') {
          ...
          $("#distance").val("");
          $('.vehicle-type-slider-box').empty().append(`<div class="data-not-found-box"><span><?php echo e(__('taxido::front.rides.unable_distance_calculation')); ?></span></div>`);
          callback(null); // Call callback with null to indicate failure
        }
      });
    } else {
      $('.vehicle-type-slider-box').empty().append(`<div class="data-not-found-box"><span><?php echo e(__('taxido::front.rides.select_location_note')); ?></span></div>`);
      callback(null); // Call callback with null to indicate failure
    }
  }
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        function(position) {
          ...
          $.ajax({
            url: "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + userLatLng.lat + "," + userLatLng.lng + "&key=<?php echo e($settings['location']['google_map_api_key'] ?? env('GOOGLE_MAP_API_KEY')); ?>",
            type: "GET",
        ...
        function(error) {
          ...
          toggleMapVisibility(false);
          alert("<?php echo e(__('taxido::front.rides.location_permission_denied')); ?> Please allow location access to use the map.");
      ...
      toggleMapVisibility(false);
      alert("<?php echo e(__('taxido::front.rides.geolocation_not_supported')); ?>");
      $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
      $('#book-ride-spinner').hide();
      $('#bookRideBtn').removeAttr('disabled');
    }
  ...
  function loadVehiclesSliderBox(serviceId, serviceCategoryID, pickUpLocation, destinationLatLng, serviceCategoryType) {
    ...
    if (serviceId && serviceCategoryID && pickUpLocation && (serviceCategoryType === 'package' || (destLat && destLng && distanceValue))) {
      ...
      $.ajax({
        ...
        success: function(data, status) {
          ...
          if (data && data.length > 0) {
                ...
                <div class="modal fade theme-modal vehicle-detail-modal" id="vehicleDetailModal-${item.id}" data-ride_id="">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn gradient-bg-color w-100" data-bs-dismiss="modal" id="closeButton"><?php echo e(__('taxido::front.rides.close')); ?></button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            $('.vehicle-type-slider-box').empty().append(`<div class="data-not-found-box"><span><?php echo e(__('taxido::front.rides.no_vehicles_available')); ?></span></div>`);
          }
        },
      ...
      $('#vehicleTypeBoxSpinner').hide();
      $('.vehicle-type-slider-box').empty().append(`<div class="data-not-found-box"><span><?php echo e(__('taxido::front.rides.required_field_note')); ?></span></div>`);
    }
  }
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            alert("<?php echo e(__('taxido::front.rides.field_ride_request')); ?>");
            $('#book-ride-spinner').hide();
            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
            $('#bookRideBtn').removeAttr('disabled');
          }
          ...
          if (rideStatus === 'accepted') {
            ...
            if (instantData?.ride_id != 'undefined') {
              $('#findDriverModal').one('hidden.bs.modal', function() {
                ...
                setTimeout(() => {
                  window.location.href = "<?php echo e(route('front.cab.ride.show', ['ride_id' => ':ride_id'])); ?>".replace(':ride_id', ride_id);
                }, 6000);
              });
            }
    ...
    function cancelRide(cancelMessage = null) {
      ...
      if (rideId) {
        ...
        instantRef.get()
          ...
          .then(() => {
            $('#findDriverModal').modal('hide');
            toastr.error(cancelMessage ?? "<?php echo e(__('taxido::front.rides.driver_not_found')); ?>");
            $('#book-ride-spinner').hide();
            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
            $('#bookRideBtn').removeAttr('disabled');
          })
        ...
        $('#findDriverModal').modal('hide');
        toastr.error("<?php echo e(__('taxido::front.rides.driver_not_found')); ?>");
        $('#book-ride-spinner').hide();
        $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
        $('#bookRideBtn').removeAttr('disabled');
      }
...
<?php echo $__env->make('front.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/front/ride/create.blade.php ENDPATH**/ ?>