<?php $__env->startSection('title', __('taxido::front.support')); ?>
<?php $__env->startSection('detailBox'); ?>
  <div class="dashboard-details-box">
    <div class="dashboard-title">
      <h3><?php echo e(__('taxido::front.chat')); ?></h3>
    </div>
                  ...
                  <div class="chat-top-box">
                    <div class="chat-profile">
                      <div id="receiverAvatarContainer">
                        <?php if($admin?->profile_image?->original_url): ?>
                            <img class="img-fluid rounded-circle" id="receiverAvatar"
                                src="<?php echo e($admin->profile_image->original_url); ?>" alt="admin">
                        <?php else: ?>
                            <div class="user-round message-profile">
                                <span><?php echo e(strtoupper($admin?->name[0])); ?></span>
                            </div>
                        <?php endif; ?>
                      </div>
                    ...
                    <div>
                      <h5 id="receiverName"><?php echo e($admin?->name ?? 'Admin'); ?></h5>
                    </div>
              ...
              <div class="message">
                <div class="msger-chat custom-scrollbar" id="messages">
                  ...
                  <div id="noMessages" class="no-chat-message">
                    <span><?php echo e(__('taxido::static.chats.no_messages_yet')); ?></span>
                  </div>
                  <div id="error"></div>
                </div>
                <form class="msger-inputarea">
                  <div class="position-relative">
                    <input class="msger-input" type="text" id="message" placeholder="<?php echo e(__('taxido::front.type_message')); ?>">
...
<script>
  ...
  const myUserId = String("<?php echo e(auth()->user()?->id); ?>");
  const myUserName = "<?php echo e(auth()->user()?->name); ?>";
  const myUserImage = "<?php echo e(auth()->user()?->profile_image?->original_url ?? ''); ?>";
  const adminId = String("<?php echo e($admin?->id); ?>");
  const adminName = "<?php echo e($admin?->name ?? 'Admin'); ?>";
  const adminImage = "<?php echo e($admin?->profile_image?->original_url ?? ''); ?>";
...
<?php echo $__env->make('taxido::front.account.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/front/account/chat.blade.php ENDPATH**/ ?>