                ...
                return `
                    ...
                    <ul class="location-driver-details">
                        ...
                        <li class="detail-item">
                            ...
                            <span>
                                <img src="${driver.payment_logo || '<?php echo e(asset('images/payment/cod.png')); ?>'}" 
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/taxido/Taxido_laravel/Modules/Taxido/resources/views/admin/driver-location/osm.blade.php ENDPATH**/ ?>