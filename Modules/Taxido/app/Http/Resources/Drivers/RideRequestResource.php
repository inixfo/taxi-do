...
class RideRequestResource extends BaseResource
{
  ...
  public function toArray(Request $request): array
  {
    $rideRequest = [
      ...
      'cargo_image_url' => getFullImageUrl($this->cargo_image?->original_url),
    ...
    if ($this->vehicle_type) {
      $rideRequest['vehicle_type'] = [
        ...
        'vehicle_image_url' => getFullImageUrl($this?->vehicle_type?->vehicle_image?->original_url),
        'vehicle_map_icon_url' => getFullImageUrl($this?->vehicle_type?->vehicle_map_icon?->original_url),
    ...
    if ($this->rental_vehicle) {
      $rideRequest['rental_vehicle'] = [
        ...
        'normal_image_url' => getFullImageUrl($this->rental_vehicle?->normal_image?->original_url),
        'front_view_url' => getFullImageUrl($this->rental_vehicle?->front_view?->original_url),
        'side_view_url' => getFullImageUrl($this->rental_vehicle?->side_view?->original_url),
        'boot_view_url' => getFullImageUrl($this->rental_vehicle?->boot_view?->original_url),
        'interior_image_url' => getFullImageUrl($this->rental_vehicle?->interior_image?->original_url),
        'registration_image' => getFullImageUrl($this->rental_vehicle?->registration_image?->original_url),
